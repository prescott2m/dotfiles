...
static const char *const autostart[] = {
	"openrc", "-U", "gui", NULL,
	"monitor-setup", NULL,
        "swaybg", "-m", "fill", "-i", "/home/p2m/bg.jpg", NULL,
...
/* commands */
static const char *menucmd[]  = { "wmenu-run", "-o", "HDMI-A-1", "-f", "Terminus 18", "-b", NULL };
static const char *termcmd[]  = { "foot",                         NULL };
static const char *volupcmd[] = { "volume-p2m",                   NULL };
static const char *voldncmd[] = { "volume-p2m",     "l",          NULL };
